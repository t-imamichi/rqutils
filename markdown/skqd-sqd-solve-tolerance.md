...
`markdown/skqd-basis-opt-optimization.md`, which is also outbound.
...
`CLAUDE.md` and `markdown/locg.md`, that per-iteration work is load-bearing — seven defects (I1–I7) that
