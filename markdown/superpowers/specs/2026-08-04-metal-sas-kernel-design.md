...
Date: 2026-08-04
Branch: `metal`
Supersedes nothing; extends `markdown/superpowers/specs/2026-08-03-mlx-sqd-poc-design.md`
...
load-bearing against catastrophic cancellation — items I5/I6 of `markdown/locg.md`,
...
`test/test_ground_locg_mlx.py` is added. This preserves the arrangement
