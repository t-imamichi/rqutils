...
Date: 2026-08-05
Extends `markdown/superpowers/specs/2026-08-03-mlx-sqd-poc-design.md` (the POC doc) and
`markdown/superpowers/specs/2026-08-04-metal-sas-kernel-design.md` (the sas-kernel doc).
...
fragility plus a below-reference energy is exactly the `markdown/locg.md` I5 signature.
