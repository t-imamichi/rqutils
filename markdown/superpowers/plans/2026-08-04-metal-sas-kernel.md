...
- Do not touch `_project_out` or `eigenpair_3x3`. Both are explicitly out of scope per the spec; their guards are items I5/I6/I1/I2 of `markdown/locg.md` and each was measured to fail *silently*.
...
- Modify: `markdown/superpowers/specs/2026-08-04-metal-sas-kernel-design.md` (the empty Results table)
...
```bash
git add markdown/superpowers/specs/2026-08-04-metal-sas-kernel-design.md
