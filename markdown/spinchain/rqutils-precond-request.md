...
def subspace(n, dim, seed):
    ...
    (no dependence on qubit 0 at all) against the correct [1, -1]. See markdown/gotchas.md
...
`markdown/sdp-lower-bound.md`.** A level-1 SDP bound is valid and ~1.45x loose on `H`, and yields **1.29x
