...
# test/test_qprint.py. matplotlib's own fallback is a fresh temp dir per process, which never warms.
...
os.environ.setdefault("JAX_COMPILATION_CACHE_DIR", os.path.join(_cache_root, "rqutils-jax"))
