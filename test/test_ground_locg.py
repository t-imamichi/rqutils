...
class TestZeroResidualAfterSeedStep:
    ...
    a zeroed direction into ``converged`` -- see items I6/I7 in ``markdown/locg.md``. ``body_iter1`` (the
...
class TestChebyshevPrefilter:
    ...
    1.0000000 against the unfiltered result. ``markdown/locg-chebyshev-prefilter.md`` has the tables.
    ...
    - **The filter's lower edge is the running Rayleigh quotient, not an accurate** ``lambda_1``. This
      ...
      the XXZ batch in ``markdown/locg-chebyshev-prefilter.md`` -- the suite will not tell you.
