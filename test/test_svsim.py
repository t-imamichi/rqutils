...
Written from ``markdown/skqd.md``, which recorded ``svsim`` as *the* blocker for sample-based Krylov
...
class TestSymplecticPhase:
    ...
    Its absence was ``markdown/skqd.md``'s blocker. These tests target the phase directly rather than
