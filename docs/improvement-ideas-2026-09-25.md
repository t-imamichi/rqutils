...
A review of what is still open after `docs/sqd-locg-improvement-ideas.md` (revised 2026-09-16). None of
...
(`tests/_sharded_allreduce_count.py`):
...
it; `poc15` on real nodes is the harness. Going below 12 needs an *algorithmic* change: the
