...
The fp32 trap measured for the LOBPCG eigensolve applies here too: a large dynamic range makes
balancing destroy small eigenvalues outright. That is why accuracy is reported as the
...
Run: uv run --extra qiskit python poc/mixed_precision.py
"""
