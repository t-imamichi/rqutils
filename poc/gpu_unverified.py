    ...
    for num_states in sizes:
        ...
        if prev is not None:
            ...
            if grew < 0.5 * ngrew:
                ...
                # recorded rather than open: markdown/scaling-pocs.md "Measured on GPU (NVIDIA GH200
                ...
                print(
                    ...
                    'markdown/scaling-pocs.md "Measured on GPU"; quotable GPU number is 5.15x at '
                    "N=64M from "
