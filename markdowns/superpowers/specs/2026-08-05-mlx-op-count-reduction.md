...
Date: 2026-08-05
Extends `markdowns/superpowers/specs/2026-08-03-mlx-sqd-poc-design.md` (the POC doc) and
`markdowns/superpowers/specs/2026-08-04-metal-sas-kernel-design.md` (the sas-kernel doc).
...
fragility plus a below-reference energy is exactly the `markdowns/locg.md` I5 signature.
