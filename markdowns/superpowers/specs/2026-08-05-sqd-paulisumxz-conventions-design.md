...
`markdowns/locg.md` those are load-bearing and measured; only the two helpers merge.
...
- `markdowns/locg.md` and `markdowns/skqd.md` need no changes — items 1-4 preserve every documented invariant,
