...
Cache `J'` of the `J` groups and recompute the rest. `markdowns/scaling-pocs.md` §2 measured this and gated it
...
`markdowns/scaling-pocs.md` §2 (the partial-J gate) and §11, `markdowns/wide-row-packing-session.md` §4.4.
