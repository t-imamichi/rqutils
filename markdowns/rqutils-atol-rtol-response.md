...
Reply to `markdowns/rqutils-atol-rtol-request.md`, from the `rqutils` side. Branch `atol-rtol`, version still
`0.2.0` (unreleased).
...
- **`poc/sharding`** agrees at all six `cache_level`s, worst deviation 8.9e-16.
