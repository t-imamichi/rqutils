...
side. A separate ask from `markdowns/rqutils-requests.md` (whose C1/C2/C3 shipped and are adopted, and whose
A1 was rejected) and from `markdowns/rqutils-precond-request.md` (withdrawn); it depends on none of them.
...
>
> Read `markdowns/rqutils-precond-request.md`'s status block before acting on this one. That request was
