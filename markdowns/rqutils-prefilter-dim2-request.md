...
>
> **Reply to the reporter: `markdowns/rqutils-prefilter-dim2-response.md`** — the explicit answer they
...
`markdowns/rqutils-precond-request.md` is still in our tree. We had observed that `precond` was reachable on
...
re-measured that and are not disputing it; the 1.79x in `markdowns/rqutils-precond-request.md` was iteration
...
bump; no action needed. We will drop `markdowns/rqutils-precond-request.md` or mark it withdrawn on our side.
