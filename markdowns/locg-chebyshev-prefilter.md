...
**Direction: inbound.** Unlike `markdowns/skqd-basis-opt-optimization.md` and
`markdowns/skqd-sqd-solve-tolerance.md`, this proposes a change to **`rqutils` itself** —
...
> `markdowns/rqutils-prefilter-bug.md`; reply and migration: `markdowns/rqutils-prefilter-bug-response.md`.
>
...
`markdowns/skqd-sqd-solve-tolerance.md` §8 records six rejected alternatives. The constraints they each
violated:
...
- `cycles` sets how many times the interval re-tightens around the descending Rayleigh quotient. Cycle 1
  does most of the work (growth factor 1e8–1e12, §5a of `markdowns/locg-next-candidates.md`), cycle 2 refines
