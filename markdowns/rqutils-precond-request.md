...
side. It is the follow-up to `markdowns/rqutils-requests.md`, whose C1/C2/C3 shipped and are adopted; this
...
def subspace(n, dim, seed):
    ...
    (no dependence on qubit 0 at all) against the correct [1, -1]. See markdowns/gotchas.md
...
`markdowns/sdp-lower-bound.md`.** A level-1 SDP bound is valid and ~1.45x loose on `H`, and yields **1.29x
